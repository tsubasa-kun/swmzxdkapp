<template>
    <div>
        ...
        <mt-button class="submit-btn" @click="doSubmit">完成</mt-button>
        <mt-button class="delete-btn" @click="doDelete">删除</mt-button>
...
<script type="text/javascript">
    ...
    import {Indicator, Picker, Button, MessageBox} from 'mint-ui';
    ...
    export default {
        data() {
            return {
                ...
                sex: this.$route.query.XBDM_DISPLAY,
                ...
                if (this.relation.length > 0 && this.name.length > 0 && this.sex.length > 0
                    ...
                    this.$http.get(Api.SAVE_STU_FAMILY_INFO + requestParamStr)
                        ...
                        .then(res => {
                            Indicator.close();
                            if (res.data.count == 1) {
                                Utils.methods.showTip('编辑成功');
                                this.$router.go(-1);
                            } else {
                                Utils.methods.showTip('编辑失败');
                            }
                        });
                } else {
            ...
            this.$http.get(Api.GET_DICTONARY + paramJTGX)
                ...
                .then(res => {
                    ...
                    for (let i = 0; i < this.relationsMap.length; i++) {
                        ...
                        if (this.$route.query.JTGXDM_DISPLAY == this.relationsMap[i].name) {
            ...
            this.$http.get(Api.GET_DICTONARY + paramJKZK)
                ...
                .then(res => {
                    ...
                    for (let i = 0; i < this.healthsMap.length; i++) {
                        ...
                        if (this.$route.query.JKZKDM_DISPLAY == this.healthsMap[i].name) {
            ...
            this.$http.get(Api.GET_DICTONARY + paramXB)
                ...
                .then(res => {
                    ...
                    for (let i = 0; i < this.sexsMap.length; i++) {
                        ...
                        if (this.$route.query.XBDM_DISPLAY == this.sexsMap[i].name) {
                            this.sexs[0].defaultIndex = i;
                        }
                    }
